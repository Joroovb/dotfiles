...
bg_default = "#181818"          # main shade darkest
bg_lighter = "#282828"
bg_selection = "#484848"
# "#545862"
fg_disabled = "#f5f5f5"
fg_default = "#e4e4ef"
# "#b6bdca"
bg_lightest = "#52494e"         # main shade lightest
fg_error = "#f43841"            # red
# "#d19a66"                     # orange
bg_hint = "#ffdd33"             # yellow
fg_matched_text = "#73c936"     # green
bg_passthrough_mode = "#96a6c8" # teal
bg_insert_mode = "#565f73"      # blue
bg_warning = "#9e95c7"          # purple
# "#be5046"                     # dark red
